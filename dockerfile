...
COPY src/nginx.crt /etc/ssl/nginx/
COPY src/nginx.key /etc/ssl/nginx/
...
COPY src/phpmyadmin /var/www/html/wordpress/phpmyadmin
ADD src/mysql-apt-config_0.8.10-1_all.deb /
